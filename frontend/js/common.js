...
// ========== WEEK 23: FOOD & DRINKS + SOME/ANY/MUCH/MANY ==========

// === СУЩЕСТВИТЕЛЬНЫЕ (продукты) ===
['bread', 'хлеб'],
['milk', 'молоко'],
['cheese', 'сыр'],
['meat', 'мясо'],
...
['little', 'мало (с неисчисл.)'],
['few', 'мало (с исчисл.)'],
['some', 'несколько, немного (в утверждении)'],
['any', 'сколько-нибудь (в вопросе/отрицании)'],
['too much', 'слишком много (с неисчисл.)'],
['too many', 'слишком много (с исчисл.)'],

// ========== WEEK 24: BIRTHDAY TREATS & ORDERING FOOD ==========
...
// === СЛОВА ДЛЯ ПРЕДЛОЖЕНИЙ ===
['shall', 'вспомогательный глагол для предложений'],
...
// ========== WEEK 25: SHOPPING & ARTICLES + WAS/WERE ==========
...
// ========== WEEK 26: PAST SIMPLE (REGULAR VERBS) ==========
...
['ride', 'аттракцион, поездка'],
['rides', 'аттракционы, поездки'],
['queue', 'очередь'],
['queues', 'очереди'],
['candyfloss', 'сахарная вата'],
['burger', 'бургер'],
['burgers', 'бургеры'],

// === ГЛАГОЛЫ (Past Simple forms) ===
['played', 'играл'],
['walked', 'ходил, гулял'],
['watched', 'смотрел'],
['cooked', 'готовил'],
['called', 'звонил'],
['liked', 'понравился, любил'],
['danced', 'танцевал'],
['tried', 'пытался, пробовал'],
['cried', 'плакал'],
['planned', 'планировал'],
['stopped', 'остановился, прекратил'],
['stayed', 'оставался, остался'],
['visited', 'посетил'],
['finished', 'закончил'],
['started', 'начал'],
['studied', 'учился, изучал'],
['enjoyed', 'наслаждался, получил удовольствие'],
['surfed', 'серфил (в интернете)'],

// === ВСПОМОГАТЕЛЬНЫЕ ГЛАГОЛЫ ===
['did', 'делал (вспомогательный)'],
["didn't", 'не (вспомогательный)'],

// === ВРЕМЕННЫЕ УКАЗАТЕЛИ (только отдельные слова) ===
['ago', 'назад'],
['yesterday', 'вчера'],
['today', 'сегодня'],
['tomorrow', 'завтра'],
...
// === НЕПРАВИЛЬНЫЕ ГЛАГОЛЫ (Past Simple) ===
['went', 'пошёл, поехал'],
['saw', 'увидел, смотрел'],
['ate', 'съел'],
['bought', 'купил'],
['wrote', 'написал'],
['read', 'читал (Past Simple, произносится /red/)'],
['took', 'взял'],
['made', 'сделал'],
['had', 'имел'],
['found', 'нашёл'],
...
// === МОДАЛЬНЫЕ ГЛАГОЛЫ ===
['must', 'должен, должно быть (предположение)'],
['might', 'возможно, может быть'],
['may', 'может быть'],
['can\'t', 'не может быть (уверенность)'],
