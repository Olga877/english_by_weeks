...
['pizza box', 'коробка из-под пиццы'],
...
// ========== ADULT: THE BODY & MODALS OF DEDUCTION — НОВЫЕ СЛОВА ==========
...
// ========== ADULT: VERBS RELATED TO THE BODY (НОВЫЕ СЛОВА) ==========
...
// === ЧАСТИ ТЕЛА (уже есть, но для полноты) ===
['nose', 'нос'],
['tongue', 'язык'],
['mouth', 'рот'],
['teeth', 'зубы'],
