...
const localDictionary = new Map([
    ...
    // ========== WEEK 12: FAMOUS PEOPLE & CAN/CAN'T (ПОЛНЫЙ СПИСОК) ==========

// Из vocabulary (Day 1-3)
['singer', 'певец/певица'],
...
// Прилагательные и наречия (ВСЕ слова из текста)
['good', 'хороший'],
['better', 'лучше, лучший'],
['best', 'лучший'],
['bad', 'плохой'],
...
['23rd', 'двадцать третий'],
['24th', 'двадцать четвёртый'],
['25th', 'двадцать пятый'],
['30th', 'тридцатый'],
['40th', 'сороковой'],
['50th', 'пятидесятый'],
...
// Имена собственные и названия (ВСЕ из текста)
...
// Вопросительные слова и выражения (отдельные слова)
['what', 'что, какой'],
['when', 'когда'],
['where', 'где, куда'],
['who', 'кто'],
...
// Выражения из упражнений (отдельные слова)
['good', 'хороший'],
['morning', 'утро'],
['afternoon', 'день'],
['evening', 'вечер'],
